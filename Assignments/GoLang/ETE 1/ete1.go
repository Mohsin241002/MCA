...
func generateReports() {
	...
	fmt.Println("1. List of Overdue Books")
	fmt.Println("2. Total Fines Collected")
	fmt.Println("3. Available Books in Library")
	fmt.Println("4. Most Borrowed Books")
	fmt.Println("5. Frequent Defaulters")
	fmt.Println("6. Show the entire report")
	...
	switch choice {
	case 1:
		reportOverdueBooks(reportDate)
	case 2:
		reportFinesCollected(reportDate)
	case 3:
		reportAvailableBooks(reportDate)
	case 4:
		reportMostBorrowedBooks(reportDate)
	case 5:
		reportFrequentDefaulters(reportDate)
	case 6:
