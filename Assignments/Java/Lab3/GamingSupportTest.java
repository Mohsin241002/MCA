...
class GamingSupportStaff extends GamingSupportPerson {
    ...
    public GamingSupportStaff() {
        this(111, "Alex", 2); // Default staff member with 2 years of experience
    }
...
public class GamingSupportTest {
    public static void main(String[] args) {
        ...
        new GamingSupportStaff(101, "Jordan", 5).displayDetails().showRoleEligibility();
        
        System.out.println("\nInexperienced Support Staff Test Case:");
        new GamingSupportStaff(102, "Taylor", 1).displayDetails().showRoleEligibility();
    }
}
